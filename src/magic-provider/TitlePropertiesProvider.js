 ...
 */
export default function TitlePropertiesProvider(propertiesPanel, translate) {
...
TitlePropertiesProvider.$inject = [ 'propertiesPanel', 'translate' ];
