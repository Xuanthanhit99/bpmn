...
export var TASK = [
 {
   ...
   className: 'bpmn-icon-task type-task',
   target: {
     type: 'bpmn:Task'
   }
 },
 {
   ...
   className: 'bpmn-icon-user type-task',
   target: {
     type: 'bpmn:UserTask'
   }
 },
 {
   ...
   className: 'bpmn-icon-service type-task',
   target: {
 ...
 },
 {
   ...
   className: 'bpmn-icon-send type-task',
   target: {
     type: 'bpmn:SendTask'
   }
 },
 {
   ...
   className: 'bpmn-icon-receive type-task',
   target: {
 ...
 },
 {
   ...
   className: 'bpmn-icon-manual type-task',
   target: {
 ...
 },
 {
   ...
   className: 'bpmn-icon-business-rule type-task',
   target: {
 ...
 },
 {
   ...
   className: 'bpmn-icon-script type-task',
   target: {
 ...
 },
 {
   ...
   className: 'bpmn-icon-call-activity type-task',
   target: {
